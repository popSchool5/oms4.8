                                                     ...
                                                     <div class="card card-accordeon-livraison">
                                                         <div class="card-header" id="heading-1">
                                                             <h2 class="card-title">
                                                                 ...
                                                                 <input type="radio" name="checkboxLivraison" value="emporter" role="button" data-toggle="collapse" href="#emporter" aria-expanded="true" aria-controls="emporter">
                                                                 Emporter
                                                                 </a>
                                                             </h2>
                                                         </div><!-- End .card-header -->
                                                         <div id="emporter" class="collapse show" aria-labelledby="heading-1" data-parent="#accordion-payment">
                                                             <div class="card-body">
                                                                 <input type="time" name="accordeonTestEmportez">
                                                             </div><!-- End .card-body -->
                                                         </div><!-- End .collapse -->
                                                     </div><!-- End .card -->
